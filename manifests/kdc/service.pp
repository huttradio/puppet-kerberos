...
) inherits kerberos::params
{
  ...
  if ($manage_dependencies)
  {
    ...
    {
      Class['::kerberos::kdc::package'] -> Service[$service]
      Class['::kerberos::kdc::conf']    ~> Service[$service]
    }
    elsif ($ensure == 'absent' or $ensure == 'stopped')
    {
      Service[$service] -> Class['::kerberos::kdc::package']
      Service[$service] -> Class['::kerberos::kdc::conf']
    }
  }
}
