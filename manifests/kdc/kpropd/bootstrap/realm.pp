...
)
{
  ...
  $command   = "'${kdc_kpropd_bootstrap_file}' '${ensure}' '${realm}' '${slave}' '${master}' '${_slave_host_principal}' '${_master_host_principal}' '${_slave_kiprop_principal}' '${_master_kiprop_principal}' '${master_ssh_key}'"
